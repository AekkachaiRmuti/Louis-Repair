                                ...
                                <div class="col-md-12 col-sm-12 col-12">
                                    <table class="table table-striped table-bordered detail-view" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><b>Job ID :</b> <?= $rs_rp["rp_job"] ?><br> <?= $rs_rp["rp_date_repair"] ?><br> <?= $rs_rp["rp_time"] ?></td>
                                                    ...
                                                    <td><b>ชื่ออุปกรณ์ : </b><?= $rs_rp["rp_serial"] ?> <br> <b>ปัญหา/งานซ่อม : </b><?= $rs_rp["rp_problem"] ?>
                                                        <?php
                                                        if ($rs_rp["rp_re_repair"] == 1) {
                                                        ?>
                                                        <br>
                                                            <a href = "index.php?page=rp_data&re_repair" style="color: red;">RE-REPAIR</a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </td>
